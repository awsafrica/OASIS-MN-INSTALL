...
#
#  +-+-+-+ +-+-+-+-+-+ +-+-+-+-+ +-+-+ +-+-+-+-+-+-+
#  |A|W|S| |O|A|S|I|S| |C|O|I|N| |M|N| |S|C|R|I|P|T|
#  +-+-+-+ +-+-+-+-+-+ +-+-+-+-+ +-+-+ +-+-+-+-+-+-+
#
#  +-+-+-+-+-+-+-+ +-+-+-+ +-+-+-+-+-+ +-+-+-+-+
...
#
#  +-+-+ +-+-+-+-+-+-+-+-+ +-+-+-+-+
#  |0|6| |F|e|b|r|u|a|r|y| |2|0|1|9|
#  +-+-+ +-+-+-+-+-+-+-+-+ +-+-+-+-+
#
#

TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='oasis.conf'
CONFIGFOLDER='/root/.oasis'
SETINELFOLDER='/root/.oasis/sentinel'
COIN_DAEMON='oasisd'
COIN_CLI='oasis-cli'
COIN_PATH='/usr/local/bin/'
KERN_ARCH=$(getconf LONG_BIT)
COIN_TGZ="https://github.com/OasisCoinTeam/Oasis/releases/download/v2.1.0/oasis-2.1.0_x86_64.tar.gz"
...
(crontab -l | grep . ; echo -e "#* * * * * cd ~/.oasis/sentinel && ./venv/bin/python bin/sentinel.py 2>&1 >> sentinel-cron.log\n") | crontab -
}
...
function important_information() {
  ...
  echo -e "Step 2 - Send exactly 285 OASIS coins to the new receiving address using your (desktop) cold wallet."
  echo -e "Step 3 - After at least 16 confirmation then enter the following command in your wallet debug console: ${RED}masternode outputs${NC}"
